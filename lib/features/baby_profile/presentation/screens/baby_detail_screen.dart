  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: babyAsync.when(
        data: (baby) {
          if (baby == null) {
            return const EmptyStateWidget(
              ...
              title: 'Profil anak tidak ditemukan',
              message: 'Profil anak ini mungkin sudah dihapus.',
            );
          }
        ...
        error: (err, _) =>
            ErrorStateWidget(message: 'Gagal memuat profil anak: $err'),
      ),
    );
  }
}
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      BabyAvatar(
                        radius: 30,
                        name: widget.baby.namaAnak,
                        photoPath: widget.baby.fotoProfilPath,
                      ),
